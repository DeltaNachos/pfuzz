...
VL_INLINE_OPT void Vsodor_top_CtlPath___nba_sequent__TOP__sodor_top__sodor_core__c__0(Vsodor_top_CtlPath* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vsodor_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vsodor_top_CtlPath___nba_sequent__TOP__sodor_top__sodor_core__c__0\n"); );
    // Body
...
VL_INLINE_OPT void Vsodor_top_CtlPath___nba_comb__TOP__sodor_top__sodor_core__c__0(Vsodor_top_CtlPath* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vsodor_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vsodor_top_CtlPath___nba_comb__TOP__sodor_top__sodor_core__c__0\n"); );
    // Body

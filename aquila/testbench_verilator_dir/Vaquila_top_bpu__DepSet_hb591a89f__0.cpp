...
VL_INLINE_OPT void Vaquila_top_bpu___ico_sequent__TOP__aquila_top__core__Branch_Prediction_Unit__0(Vaquila_top_bpu* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vaquila_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vaquila_top_bpu___ico_sequent__TOP__aquila_top__core__Branch_Prediction_Unit__0\n"); );
    // Body
    vlSymsp->TOP__aquila_top__core__Branch_Prediction_Unit__bpu_pc_history.__PVT__clk_i 
        = vlSelf->__PVT__clk_i;
}

VL_INLINE_OPT void Vaquila_top_bpu___nba_sequent__TOP__aquila_top__core__Branch_Prediction_Unit__1(Vaquila_top_bpu* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vaquila_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vaquila_top_bpu___nba_sequent__TOP__aquila_top__core__Branch_Prediction_Unit__1\n"); );
    // Body
    vlSymsp->TOP__aquila_top__core__Branch_Prediction_Unit__bpu_pc_history.__PVT__write_addr_i 
        = vlSelf->__PVT__write_addr;
}

VL_INLINE_OPT void Vaquila_top_bpu___nba_comb__TOP__aquila_top__core__Branch_Prediction_Unit__0(Vaquila_top_bpu* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vaquila_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vaquila_top_bpu___nba_comb__TOP__aquila_top__core__Branch_Prediction_Unit__0\n"); );
    // Body
...
VL_INLINE_OPT void Vaquila_top_bpu___nba_comb__TOP__aquila_top__core__Branch_Prediction_Unit__2(Vaquila_top_bpu* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vaquila_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vaquila_top_bpu___nba_comb__TOP__aquila_top__core__Branch_Prediction_Unit__2\n"); );
    // Body
...
VL_INLINE_OPT void Vaquila_top_bpu___nba_comb__TOP__aquila_top__core__Branch_Prediction_Unit__3(Vaquila_top_bpu* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vaquila_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vaquila_top_bpu___nba_comb__TOP__aquila_top__core__Branch_Prediction_Unit__3\n"); );
    // Body
    vlSymsp->TOP__aquila_top__core__Branch_Prediction_Unit__bpu_pc_history.__PVT__data_i 
        = vlSelf->__PVT__branch_target_addr_i;
}

VL_INLINE_OPT void Vaquila_top_bpu___nba_comb__TOP__aquila_top__core__Branch_Prediction_Unit__4(Vaquila_top_bpu* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vaquila_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vaquila_top_bpu___nba_comb__TOP__aquila_top__core__Branch_Prediction_Unit__4\n"); );
    // Body

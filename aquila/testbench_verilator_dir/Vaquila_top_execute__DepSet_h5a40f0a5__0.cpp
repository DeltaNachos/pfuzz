...
VL_INLINE_OPT void Vaquila_top_execute___ico_sequent__TOP__aquila_top__core__Execute__0(Vaquila_top_execute* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vaquila_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vaquila_top_execute___ico_sequent__TOP__aquila_top__core__Execute__0\n"); );
    // Body
    vlSymsp->TOP__aquila_top__core__Execute__MulDiv.__PVT__clk_i 
        = vlSelf->__PVT__clk_i;
}

VL_INLINE_OPT void Vaquila_top_execute___nba_sequent__TOP__aquila_top__core__Execute__0(Vaquila_top_execute* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vaquila_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vaquila_top_execute___nba_sequent__TOP__aquila_top__core__Execute__0\n"); );
    // Body
...
VL_INLINE_OPT void Vaquila_top_execute___nba_sequent__TOP__aquila_top__core__Execute__2(Vaquila_top_execute* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vaquila_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vaquila_top_execute___nba_sequent__TOP__aquila_top__core__Execute__2\n"); );
    // Body
...
VL_INLINE_OPT void Vaquila_top_execute___nba_sequent__TOP__aquila_top__core__Execute__3(Vaquila_top_execute* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vaquila_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vaquila_top_execute___nba_sequent__TOP__aquila_top__core__Execute__3\n"); );
    // Body
    vlSymsp->TOP__aquila_top__core__Execute__MulDiv.__PVT__rst_i 
        = vlSelf->__PVT__rst_i;
}

VL_INLINE_OPT void Vaquila_top_execute___nba_comb__TOP__aquila_top__core__Execute__0(Vaquila_top_execute* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vaquila_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vaquila_top_execute___nba_comb__TOP__aquila_top__core__Execute__0\n"); );
    // Body
...
VL_INLINE_OPT void Vaquila_top_execute___nba_comb__TOP__aquila_top__core__Execute__1(Vaquila_top_execute* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vaquila_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vaquila_top_execute___nba_comb__TOP__aquila_top__core__Execute__1\n"); );
    // Body
...
VL_INLINE_OPT void Vaquila_top_execute___nba_comb__TOP__aquila_top__core__Execute__2(Vaquila_top_execute* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vaquila_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vaquila_top_execute___nba_comb__TOP__aquila_top__core__Execute__2\n"); );
    // Body
...
VL_INLINE_OPT void Vaquila_top_execute___nba_comb__TOP__aquila_top__core__Execute__3(Vaquila_top_execute* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vaquila_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vaquila_top_execute___nba_comb__TOP__aquila_top__core__Execute__3\n"); );
    // Body

...
VL_INLINE_OPT void Vaquila_top_forwarding_unit___nba_sequent__TOP__aquila_top__core__Forwarding_Unit__0(Vaquila_top_forwarding_unit* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vaquila_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vaquila_top_forwarding_unit___nba_sequent__TOP__aquila_top__core__Forwarding_Unit__0\n"); );
    // Body
...
VL_INLINE_OPT void Vaquila_top_forwarding_unit___nba_sequent__TOP__aquila_top__core__Forwarding_Unit__1(Vaquila_top_forwarding_unit* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vaquila_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vaquila_top_forwarding_unit___nba_sequent__TOP__aquila_top__core__Forwarding_Unit__1\n"); );
    // Body
...
VL_INLINE_OPT void Vaquila_top_forwarding_unit___nba_comb__TOP__aquila_top__core__Forwarding_Unit__0(Vaquila_top_forwarding_unit* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vaquila_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vaquila_top_forwarding_unit___nba_comb__TOP__aquila_top__core__Forwarding_Unit__0\n"); );
    // Body
...
VL_INLINE_OPT void Vaquila_top_forwarding_unit___nba_comb__TOP__aquila_top__core__Forwarding_Unit__1(Vaquila_top_forwarding_unit* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vaquila_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vaquila_top_forwarding_unit___nba_comb__TOP__aquila_top__core__Forwarding_Unit__1\n"); );
    // Body
...
VL_INLINE_OPT void Vaquila_top_forwarding_unit___nba_comb__TOP__aquila_top__core__Forwarding_Unit__2(Vaquila_top_forwarding_unit* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vaquila_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vaquila_top_forwarding_unit___nba_comb__TOP__aquila_top__core__Forwarding_Unit__2\n"); );
    // Body

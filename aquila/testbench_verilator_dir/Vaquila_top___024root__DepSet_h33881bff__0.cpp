...
void Vaquila_top___024root___eval_act(Vaquila_top___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vaquila_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vaquila_top___024root___eval_act\n"); );
}
...
void Vaquila_top___024root___eval(Vaquila_top___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vaquila_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vaquila_top___024root___eval\n"); );
    // Init
    ...
    while (vlSelf->__VicoContinue) {
        ...
        Vaquila_top___024root___eval_triggers__ico(vlSelf);
...
#endif
                VL_FATAL_MT("aquila_top.v", 4, "", "Input combinational region did not converge.");
            }
            __Vtemp_1 = ((IData)(1U) + vlSelf->__VicoIterCount);
            vlSelf->__VicoIterCount = __Vtemp_1;
            Vaquila_top___024root___eval_ico(vlSelf);
        }
    }
    ...
    while (vlSelf->__VnbaContinue) {
        ...
        while (vlSelf->__VactContinue) {
            ...
            Vaquila_top___024root___eval_triggers__act(vlSelf);
            if (vlSelf->__VactTriggered.any()) {
...
#endif
                    VL_FATAL_MT("aquila_top.v", 4, "", "Active region did not converge.");
                }
                ...
                Vaquila_top___024root___eval_act(vlSelf);
            }
        }
...
#ifdef VL_DEBUG
                Vaquila_top___024root___dump_triggers__nba(vlSelf);
#endif
                VL_FATAL_MT("aquila_top.v", 4, "", "NBA region did not converge.");
            }
            __Vtemp_3 = ((IData)(1U) + vlSelf->__VnbaIterCount);
            vlSelf->__VnbaIterCount = __Vtemp_3;
            Vaquila_top___024root___eval_nba(vlSelf);
        }
    }
}
...
void Vaquila_top___024root___eval_debug_assertions(Vaquila_top___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vaquila_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vaquila_top___024root___eval_debug_assertions\n"); );
    // Body

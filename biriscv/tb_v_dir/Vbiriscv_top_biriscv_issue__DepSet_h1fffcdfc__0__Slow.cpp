...
VL_ATTR_COLD void Vbiriscv_top_biriscv_issue___eval_initial__TOP__biriscv_top__u_core__u_issue(Vbiriscv_top_biriscv_issue* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vbiriscv_top_biriscv_issue___eval_initial__TOP__biriscv_top__u_core__u_issue\n"); );
    // Body
    vlSymsp->TOP__biriscv_top__u_core__u_issue__u_pipe0_ctrl.__PVT__squash_wb_i = 0U;
    vlSymsp->TOP__biriscv_top__u_core__u_issue__u_pipe1_ctrl.__PVT__issue_div_i = 0U;
    vlSymsp->TOP__biriscv_top__u_core__u_issue__u_pipe1_ctrl.__PVT__issue_csr_i = 0U;
    vlSelf->__PVT__enable_dual_issue_w = 1U;
    vlSelf->__PVT__enable_muldiv_w = 1U;
    vlSelf->__PVT__enable_mul_bypass_w = 1U;
    vlSelf->__PVT__opcode0_invalid_o = 0U;
    vlSelf->__PVT__opcode1_invalid_o = 0U;
...
VL_ATTR_COLD void Vbiriscv_top_biriscv_issue___stl_sequent__TOP__biriscv_top__u_core__u_issue__0(Vbiriscv_top_biriscv_issue* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vbiriscv_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vbiriscv_top_biriscv_issue___stl_sequent__TOP__biriscv_top__u_core__u_issue__0\n"); );
    // Body
...
VL_ATTR_COLD void Vbiriscv_top_biriscv_issue___stl_sequent__TOP__biriscv_top__u_core__u_issue__1(Vbiriscv_top_biriscv_issue* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vbiriscv_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vbiriscv_top_biriscv_issue___stl_sequent__TOP__biriscv_top__u_core__u_issue__1\n"); );
    // Body
...
VL_ATTR_COLD void Vbiriscv_top_biriscv_issue___stl_sequent__TOP__biriscv_top__u_core__u_issue__2(Vbiriscv_top_biriscv_issue* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vbiriscv_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vbiriscv_top_biriscv_issue___stl_sequent__TOP__biriscv_top__u_core__u_issue__2\n"); );
    // Body
...
VL_ATTR_COLD void Vbiriscv_top_biriscv_issue___stl_sequent__TOP__biriscv_top__u_core__u_issue__3(Vbiriscv_top_biriscv_issue* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vbiriscv_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vbiriscv_top_biriscv_issue___stl_sequent__TOP__biriscv_top__u_core__u_issue__3\n"); );
    // Body
...
VL_ATTR_COLD void Vbiriscv_top_biriscv_issue___stl_sequent__TOP__biriscv_top__u_core__u_issue__4(Vbiriscv_top_biriscv_issue* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vbiriscv_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vbiriscv_top_biriscv_issue___stl_sequent__TOP__biriscv_top__u_core__u_issue__4\n"); );
    // Body
...
VL_ATTR_COLD void Vbiriscv_top_biriscv_issue___stl_sequent__TOP__biriscv_top__u_core__u_issue__5(Vbiriscv_top_biriscv_issue* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vbiriscv_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vbiriscv_top_biriscv_issue___stl_sequent__TOP__biriscv_top__u_core__u_issue__5\n"); );
    // Body

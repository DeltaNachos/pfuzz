...
#ifndef VERILATED_VBIRISCV_TOP_BIRISCV_MULTIPLIER_H_
#define VERILATED_VBIRISCV_TOP_BIRISCV_MULTIPLIER_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vbiriscv_top_biriscv_multiplier final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vbiriscv_top_biriscv_multiplier(Vbiriscv_top__Syms* symsp, const char* v__name);
    ~Vbiriscv_top_biriscv_multiplier();
    VL_UNCOPYABLE(Vbiriscv_top_biriscv_multiplier);

...
VL_INLINE_OPT void Vbiriscv_top_biriscv_npc___ico_sequent__TOP__biriscv_top__u_core__u_frontend__u_npc__0(Vbiriscv_top_biriscv_npc* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vbiriscv_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vbiriscv_top_biriscv_npc___ico_sequent__TOP__biriscv_top__u_core__u_frontend__u_npc__0\n"); );
    // Body
    vlSymsp->TOP__biriscv_top__u_core__u_frontend__u_npc__BRANCH_PREDICTION__DOT__u_lru.__PVT__clk_i 
        = vlSelf->__PVT__clk_i;
}

VL_INLINE_OPT void Vbiriscv_top_biriscv_npc___nba_sequent__TOP__biriscv_top__u_core__u_frontend__u_npc__1(Vbiriscv_top_biriscv_npc* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vbiriscv_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vbiriscv_top_biriscv_npc___nba_sequent__TOP__biriscv_top__u_core__u_frontend__u_npc__1\n"); );
    // Body
    vlSymsp->TOP__biriscv_top__u_core__u_frontend__u_npc__BRANCH_PREDICTION__DOT__u_lru.__PVT__rst_i 
        = vlSelf->__PVT__rst_i;
}

VL_INLINE_OPT void Vbiriscv_top_biriscv_npc___nba_sequent__TOP__biriscv_top__u_core__u_frontend__u_npc__2(Vbiriscv_top_biriscv_npc* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vbiriscv_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vbiriscv_top_biriscv_npc___nba_sequent__TOP__biriscv_top__u_core__u_frontend__u_npc__2\n"); );
    // Body
...
VL_INLINE_OPT void Vbiriscv_top_biriscv_npc___nba_comb__TOP__biriscv_top__u_core__u_frontend__u_npc__0(Vbiriscv_top_biriscv_npc* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vbiriscv_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vbiriscv_top_biriscv_npc___nba_comb__TOP__biriscv_top__u_core__u_frontend__u_npc__0\n"); );
    // Body
...
VL_INLINE_OPT void Vbiriscv_top_biriscv_npc___nba_comb__TOP__biriscv_top__u_core__u_frontend__u_npc__3(Vbiriscv_top_biriscv_npc* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vbiriscv_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vbiriscv_top_biriscv_npc___nba_comb__TOP__biriscv_top__u_core__u_frontend__u_npc__3\n"); );
    // Body

...
VL_ATTR_COLD void Vbiriscv_top_biriscv_lsu__pi2___eval_initial__TOP__biriscv_top__u_core__u_lsu(Vbiriscv_top_biriscv_lsu__pi2* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vbiriscv_top_biriscv_lsu__pi2___eval_initial__TOP__biriscv_top__u_core__u_lsu\n"); );
    // Body
...
VL_ATTR_COLD void Vbiriscv_top_biriscv_lsu__pi2___stl_sequent__TOP__biriscv_top__u_core__u_lsu__3(Vbiriscv_top_biriscv_lsu__pi2* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vbiriscv_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vbiriscv_top_biriscv_lsu__pi2___stl_sequent__TOP__biriscv_top__u_core__u_lsu__3\n"); );
    // Body
...
VL_ATTR_COLD void Vbiriscv_top_biriscv_lsu__pi2___ctor_var_reset(Vbiriscv_top_biriscv_lsu__pi2* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vbiriscv_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vbiriscv_top_biriscv_lsu__pi2___ctor_var_reset\n"); );
    // Body

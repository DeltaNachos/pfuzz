...
VL_INLINE_OPT void Vbiriscv_top_biriscv_multiplier___nba_sequent__TOP__biriscv_top__u_core__u_mul__0(Vbiriscv_top_biriscv_multiplier* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vbiriscv_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vbiriscv_top_biriscv_multiplier___nba_sequent__TOP__biriscv_top__u_core__u_mul__0\n"); );
    // Init
...
VL_INLINE_OPT void Vbiriscv_top_biriscv_multiplier___nba_comb__TOP__biriscv_top__u_core__u_mul__0(Vbiriscv_top_biriscv_multiplier* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vbiriscv_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vbiriscv_top_biriscv_multiplier___nba_comb__TOP__biriscv_top__u_core__u_mul__0\n"); );
    // Body
...
VL_INLINE_OPT void Vbiriscv_top_biriscv_multiplier___nba_comb__TOP__biriscv_top__u_core__u_mul__1(Vbiriscv_top_biriscv_multiplier* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vbiriscv_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vbiriscv_top_biriscv_multiplier___nba_comb__TOP__biriscv_top__u_core__u_mul__1\n"); );
    // Body

...
#ifndef VERILATED_VBIRISCV_TOP_BIRISCV_MMU__PI1_H_
#define VERILATED_VBIRISCV_TOP_BIRISCV_MMU__PI1_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vbiriscv_top_biriscv_mmu__pi1 final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        VL_IN64(__PVT__fetch_out_inst_i,63,0);
        VL_OUT64(__PVT__fetch_in_inst_o,63,0);
    };
    ...
    // CONSTRUCTORS
    Vbiriscv_top_biriscv_mmu__pi1(Vbiriscv_top__Syms* symsp, const char* v__name);
    ~Vbiriscv_top_biriscv_mmu__pi1();
    VL_UNCOPYABLE(Vbiriscv_top_biriscv_mmu__pi1);

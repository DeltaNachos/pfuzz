...
VL_INLINE_OPT void Vbiriscv_top_biriscv_csr___ico_sequent__TOP__biriscv_top__u_core__u_csr__0(Vbiriscv_top_biriscv_csr* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vbiriscv_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vbiriscv_top_biriscv_csr___ico_sequent__TOP__biriscv_top__u_core__u_csr__0\n"); );
    // Body
    vlSymsp->TOP__biriscv_top__u_core__u_csr__u_csrfile.__PVT__clk_i 
        = vlSelf->__PVT__clk_i;
}

VL_INLINE_OPT void Vbiriscv_top_biriscv_csr___nba_sequent__TOP__biriscv_top__u_core__u_csr__0(Vbiriscv_top_biriscv_csr* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vbiriscv_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vbiriscv_top_biriscv_csr___nba_sequent__TOP__biriscv_top__u_core__u_csr__0\n"); );
    // Body
...
VL_INLINE_OPT void Vbiriscv_top_biriscv_csr___nba_sequent__TOP__biriscv_top__u_core__u_csr__2(Vbiriscv_top_biriscv_csr* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vbiriscv_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vbiriscv_top_biriscv_csr___nba_sequent__TOP__biriscv_top__u_core__u_csr__2\n"); );
    // Body
    vlSymsp->TOP__biriscv_top__u_core__u_csr__u_csrfile.__PVT__rst_i 
        = vlSelf->__PVT__rst_i;
}

VL_INLINE_OPT void Vbiriscv_top_biriscv_csr___nba_sequent__TOP__biriscv_top__u_core__u_csr__3(Vbiriscv_top_biriscv_csr* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vbiriscv_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vbiriscv_top_biriscv_csr___nba_sequent__TOP__biriscv_top__u_core__u_csr__3\n"); );
    // Body
    vlSymsp->TOP__biriscv_top__u_core__u_csr__u_csrfile.__PVT__ext_intr_i 
        = vlSelf->__PVT__intr_i;
}

VL_INLINE_OPT void Vbiriscv_top_biriscv_csr___nba_sequent__TOP__biriscv_top__u_core__u_csr__4(Vbiriscv_top_biriscv_csr* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vbiriscv_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vbiriscv_top_biriscv_csr___nba_sequent__TOP__biriscv_top__u_core__u_csr__4\n"); );
    // Body
...
VL_INLINE_OPT void Vbiriscv_top_biriscv_csr___nba_sequent__TOP__biriscv_top__u_core__u_csr__5(Vbiriscv_top_biriscv_csr* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vbiriscv_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vbiriscv_top_biriscv_csr___nba_sequent__TOP__biriscv_top__u_core__u_csr__5\n"); );
    // Body
...
VL_INLINE_OPT void Vbiriscv_top_biriscv_csr___nba_comb__TOP__biriscv_top__u_core__u_csr__0(Vbiriscv_top_biriscv_csr* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vbiriscv_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vbiriscv_top_biriscv_csr___nba_comb__TOP__biriscv_top__u_core__u_csr__0\n"); );
    // Body
...
VL_INLINE_OPT void Vbiriscv_top_biriscv_csr___nba_comb__TOP__biriscv_top__u_core__u_csr__1(Vbiriscv_top_biriscv_csr* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vbiriscv_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vbiriscv_top_biriscv_csr___nba_comb__TOP__biriscv_top__u_core__u_csr__1\n"); );
    // Body
...
VL_INLINE_OPT void Vbiriscv_top_biriscv_csr___nba_comb__TOP__biriscv_top__u_core__u_csr__2(Vbiriscv_top_biriscv_csr* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vbiriscv_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vbiriscv_top_biriscv_csr___nba_comb__TOP__biriscv_top__u_core__u_csr__2\n"); );
    // Body
...
VL_INLINE_OPT void Vbiriscv_top_biriscv_csr___nba_comb__TOP__biriscv_top__u_core__u_csr__3(Vbiriscv_top_biriscv_csr* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vbiriscv_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vbiriscv_top_biriscv_csr___nba_comb__TOP__biriscv_top__u_core__u_csr__3\n"); );
    // Body
...
VL_INLINE_OPT void Vbiriscv_top_biriscv_csr___nba_comb__TOP__biriscv_top__u_core__u_csr__4(Vbiriscv_top_biriscv_csr* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vbiriscv_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vbiriscv_top_biriscv_csr___nba_comb__TOP__biriscv_top__u_core__u_csr__4\n"); );
    // Body

...
#ifndef VERILATED_VBIRISCV_TOP_BIRISCV_DIVIDER_H_
#define VERILATED_VBIRISCV_TOP_BIRISCV_DIVIDER_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vbiriscv_top_biriscv_divider final : public VerilatedModule {
  public:
    ...
    CData/*0:0*/ __PVT__last_div_q;
    CData/*0:0*/ __PVT__last_divu_q;
    CData/*0:0*/ __PVT__last_rem_q;
    CData/*0:0*/ __PVT__last_remu_q;
    ...
    CData/*0:0*/ __Vdly__last_div_q;
    CData/*0:0*/ __Vdly__last_divu_q;
    CData/*0:0*/ __Vdly__last_rem_q;
    CData/*0:0*/ __Vdly__last_remu_q;
    ...
    // CONSTRUCTORS
    Vbiriscv_top_biriscv_divider(Vbiriscv_top__Syms* symsp, const char* v__name);
    ~Vbiriscv_top_biriscv_divider();
    VL_UNCOPYABLE(Vbiriscv_top_biriscv_divider);

...
#ifndef VERILATED_VBIRISCV_TOP_BIRISCV_PIPE_CTRL_H_
#define VERILATED_VBIRISCV_TOP_BIRISCV_PIPE_CTRL_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vbiriscv_top_biriscv_pipe_ctrl final : public VerilatedModule {
  public:
    // CELLS
    Vbiriscv_top_biriscv_trace_sim* __PVT__u_trace_d;
    Vbiriscv_top_biriscv_trace_sim* __PVT__u_trace_wb;
    ...
    // CONSTRUCTORS
    Vbiriscv_top_biriscv_pipe_ctrl(Vbiriscv_top__Syms* symsp, const char* v__name);
    ~Vbiriscv_top_biriscv_pipe_ctrl();
    VL_UNCOPYABLE(Vbiriscv_top_biriscv_pipe_ctrl);

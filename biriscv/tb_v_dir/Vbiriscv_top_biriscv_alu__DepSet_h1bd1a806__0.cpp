...
VL_INLINE_OPT void Vbiriscv_top_biriscv_alu___nba_comb__TOP__biriscv_top__u_core__u_exec0__u_alu__0(Vbiriscv_top_biriscv_alu* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vbiriscv_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vbiriscv_top_biriscv_alu___nba_comb__TOP__biriscv_top__u_core__u_exec0__u_alu__0\n"); );
    // Body
...
VL_INLINE_OPT void Vbiriscv_top_biriscv_alu___nba_comb__TOP__biriscv_top__u_core__u_exec1__u_alu__0(Vbiriscv_top_biriscv_alu* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vbiriscv_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vbiriscv_top_biriscv_alu___nba_comb__TOP__biriscv_top__u_core__u_exec1__u_alu__0\n"); );
    // Body
    vlSelf->__PVT__sub_res_w = (vlSelf->__PVT__alu_a_i 
                                - vlSelf->__PVT__alu_b_i);
    vlSelf->__PVT__shift_right_fill_r = 0U;

...
#ifndef VERILATED_VBIRISCV_TOP_BIRISCV_CSR_H_
#define VERILATED_VBIRISCV_TOP_BIRISCV_CSR_H_  // guard

#include "verilated.h"
class Vbiriscv_top_biriscv_csr_regfile__SB1;


class Vbiriscv_top__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vbiriscv_top_biriscv_csr final : public VerilatedModule {
  public:
    // CELLS
    Vbiriscv_top_biriscv_csr_regfile__SB1* u_csrfile;
    ...
    // CONSTRUCTORS
    Vbiriscv_top_biriscv_csr(Vbiriscv_top__Syms* symsp, const char* v__name);
    ~Vbiriscv_top_biriscv_csr();
    VL_UNCOPYABLE(Vbiriscv_top_biriscv_csr);

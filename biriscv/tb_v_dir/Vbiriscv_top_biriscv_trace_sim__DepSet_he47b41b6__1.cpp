...
VL_INLINE_OPT void Vbiriscv_top_biriscv_trace_sim___nba_sequent__TOP__biriscv_top__u_core__u_issue__u_pipe0_dec1_verif__0(Vbiriscv_top_biriscv_trace_sim* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vbiriscv_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vbiriscv_top_biriscv_trace_sim___nba_sequent__TOP__biriscv_top__u_core__u_issue__u_pipe0_dec1_verif__0\n"); );
    // Body
...
VL_INLINE_OPT void Vbiriscv_top_biriscv_trace_sim___nba_comb__TOP__biriscv_top__u_core__u_issue__u_pipe0_dec1_verif__0(Vbiriscv_top_biriscv_trace_sim* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vbiriscv_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vbiriscv_top_biriscv_trace_sim___nba_comb__TOP__biriscv_top__u_core__u_issue__u_pipe0_dec1_verif__0\n"); );
    // Init

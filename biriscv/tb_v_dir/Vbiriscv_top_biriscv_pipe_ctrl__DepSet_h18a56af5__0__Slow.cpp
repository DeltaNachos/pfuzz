...
VL_ATTR_COLD void Vbiriscv_top_biriscv_pipe_ctrl___stl_sequent__TOP__biriscv_top__u_core__u_issue__u_pipe0_ctrl__1(Vbiriscv_top_biriscv_pipe_ctrl* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vbiriscv_top_biriscv_pipe_ctrl___stl_sequent__TOP__biriscv_top__u_core__u_issue__u_pipe0_ctrl__1\n"); );
    // Body
...
VL_ATTR_COLD void Vbiriscv_top_biriscv_pipe_ctrl___stl_sequent__TOP__biriscv_top__u_core__u_issue__u_pipe0_ctrl__4(Vbiriscv_top_biriscv_pipe_ctrl* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vbiriscv_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vbiriscv_top_biriscv_pipe_ctrl___stl_sequent__TOP__biriscv_top__u_core__u_issue__u_pipe0_ctrl__4\n"); );
    // Body
...
VL_ATTR_COLD void Vbiriscv_top_biriscv_pipe_ctrl___stl_sequent__TOP__biriscv_top__u_core__u_issue__u_pipe1_ctrl__1(Vbiriscv_top_biriscv_pipe_ctrl* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vbiriscv_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vbiriscv_top_biriscv_pipe_ctrl___stl_sequent__TOP__biriscv_top__u_core__u_issue__u_pipe1_ctrl__1\n"); );
    // Body
    vlSelf->__PVT__stall_o = (1U & ((VL_BITSEL_IIII(10, (IData)(vlSelf->__PVT__ctrl_e1_q), 4U) 
                                     & (~ (IData)(vlSelf->__PVT__div_complete_i))) 
                                    | ((VL_BITSEL_IIII(10, (IData)(vlSelf->__PVT__ctrl_e2_q), 1U) 
...
VL_ATTR_COLD void Vbiriscv_top_biriscv_pipe_ctrl___stl_sequent__TOP__biriscv_top__u_core__u_issue__u_pipe1_ctrl__4(Vbiriscv_top_biriscv_pipe_ctrl* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vbiriscv_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vbiriscv_top_biriscv_pipe_ctrl___stl_sequent__TOP__biriscv_top__u_core__u_issue__u_pipe1_ctrl__4\n"); );
    // Body
    vlSelf->__PVT__branch_misaligned_w = ((IData)(vlSelf->__PVT__issue_branch_taken_i) 
                                          & (0U != 
                                             (3U & 
...
VL_ATTR_COLD void Vbiriscv_top_biriscv_pipe_ctrl___ctor_var_reset(Vbiriscv_top_biriscv_pipe_ctrl* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vbiriscv_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vbiriscv_top_biriscv_pipe_ctrl___ctor_var_reset\n"); );
    // Body

...
VL_ATTR_COLD void Vbiriscv_top_biriscv_alu___stl_sequent__TOP__biriscv_top__u_core__u_exec0__u_alu__0(Vbiriscv_top_biriscv_alu* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vbiriscv_top_biriscv_alu___stl_sequent__TOP__biriscv_top__u_core__u_exec0__u_alu__0\n"); );
    // Body
...
VL_ATTR_COLD void Vbiriscv_top_biriscv_alu___stl_sequent__TOP__biriscv_top__u_core__u_exec1__u_alu__0(Vbiriscv_top_biriscv_alu* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vbiriscv_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vbiriscv_top_biriscv_alu___stl_sequent__TOP__biriscv_top__u_core__u_exec1__u_alu__0\n"); );
    // Body
    vlSelf->__PVT__sub_res_w = (vlSelf->__PVT__alu_a_i 
                                - vlSelf->__PVT__alu_b_i);
    vlSelf->__PVT__shift_right_fill_r = 0U;
...
VL_ATTR_COLD void Vbiriscv_top_biriscv_alu___ctor_var_reset(Vbiriscv_top_biriscv_alu* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vbiriscv_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vbiriscv_top_biriscv_alu___ctor_var_reset\n"); );
    // Body
    vlSelf->__PVT__alu_op_i = VL_RAND_RESET_I(4);
    vlSelf->__PVT__alu_a_i = VL_RAND_RESET_I(32);
    vlSelf->__PVT__alu_b_i = VL_RAND_RESET_I(32);
    vlSelf->__PVT__alu_p_o = VL_RAND_RESET_I(32);
    vlSelf->__PVT__result_r = VL_RAND_RESET_I(32);
    vlSelf->__PVT__shift_right_fill_r = VL_RAND_RESET_I(16);
    vlSelf->__PVT__shift_right_1_r = VL_RAND_RESET_I(32);
    vlSelf->__PVT__shift_right_2_r = VL_RAND_RESET_I(32);
    vlSelf->__PVT__shift_right_4_r = VL_RAND_RESET_I(32);
    vlSelf->__PVT__shift_right_8_r = VL_RAND_RESET_I(32);
    vlSelf->__PVT__shift_left_1_r = VL_RAND_RESET_I(32);
    vlSelf->__PVT__shift_left_2_r = VL_RAND_RESET_I(32);
    vlSelf->__PVT__shift_left_4_r = VL_RAND_RESET_I(32);
    vlSelf->__PVT__shift_left_8_r = VL_RAND_RESET_I(32);
    vlSelf->__PVT__sub_res_w = VL_RAND_RESET_I(32);
}

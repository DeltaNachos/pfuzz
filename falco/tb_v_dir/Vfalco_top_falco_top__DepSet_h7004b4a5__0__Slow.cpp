...
VL_ATTR_COLD void Vfalco_top_falco_top___stl_sequent__TOP__falco_top__0(Vfalco_top_falco_top* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+      Vfalco_top_falco_top___stl_sequent__TOP__falco_top__0\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__load_data_req = vlSymsp->TOP__falco_top__core.__PVT__load_data_req;
    vlSymsp->TOP__falco_top__core.__PVT__init_pc = vlSelfRef.__PVT__init_pc;
    ...
    vlSymsp->TOP__falco_top__memory_modelling_inst.__PVT__load_data_req 
        = vlSelfRef.__PVT__load_data_req;
...
VL_ATTR_COLD void Vfalco_top_falco_top___stl_sequent__TOP__falco_top__1(Vfalco_top_falco_top* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vfalco_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+      Vfalco_top_falco_top___stl_sequent__TOP__falco_top__1\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vfalco_top_falco_top___stl_sequent__TOP__falco_top__2(Vfalco_top_falco_top* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vfalco_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+      Vfalco_top_falco_top___stl_sequent__TOP__falco_top__2\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vfalco_top_falco_top___stl_comb__TOP__falco_top__0(Vfalco_top_falco_top* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vfalco_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+      Vfalco_top_falco_top___stl_comb__TOP__falco_top__0\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body

...
VL_ATTR_COLD void Vfalco_top_decoder___eval_initial__TOP__falco_top__core__instruction_decode__instr0_decoder(Vfalco_top_decoder* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vfalco_top_decoder___eval_initial__TOP__falco_top__core__instruction_decode__instr0_decoder\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    VL_ASSIGNSEL_WI(192,32,0x20U, vlSelfRef.__PVT__decoded_instr, 0U);
}
...
VL_ATTR_COLD void Vfalco_top_decoder___stl_sequent__TOP__falco_top__core__instruction_decode__instr0_decoder__0(Vfalco_top_decoder* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vfalco_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vfalco_top_decoder___stl_sequent__TOP__falco_top__core__instruction_decode__instr0_decoder__0\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    VL_ASSIGNSEL_WQ(192,64,0x80U, vlSelfRef.__PVT__decoded_instr, 
                    VL_CONCAT_QII(64,32,32, vlSelfRef.__PVT__predict_pc, vlSelfRef.__PVT__pc));
}
...
VL_ATTR_COLD void Vfalco_top_decoder___stl_sequent__TOP__falco_top__core__instruction_decode__instr0_decoder__1(Vfalco_top_decoder* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vfalco_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vfalco_top_decoder___stl_sequent__TOP__falco_top__core__instruction_decode__instr0_decoder__1\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vfalco_top_decoder___eval_initial__TOP__falco_top__core__instruction_decode__instr1_decoder(Vfalco_top_decoder* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vfalco_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vfalco_top_decoder___eval_initial__TOP__falco_top__core__instruction_decode__instr1_decoder\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    VL_ASSIGNSEL_WI(192,32,0x20U, vlSelfRef.__PVT__decoded_instr, 0U);
}
...
VL_ATTR_COLD void Vfalco_top_decoder___stl_sequent__TOP__falco_top__core__instruction_decode__instr1_decoder__0(Vfalco_top_decoder* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vfalco_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vfalco_top_decoder___stl_sequent__TOP__falco_top__core__instruction_decode__instr1_decoder__0\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vfalco_top_decoder___stl_sequent__TOP__falco_top__core__instruction_decode__instr1_decoder__1(Vfalco_top_decoder* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vfalco_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vfalco_top_decoder___stl_sequent__TOP__falco_top__core__instruction_decode__instr1_decoder__1\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vfalco_top_decoder___ctor_var_reset(Vfalco_top_decoder* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vfalco_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vfalco_top_decoder___ctor_var_reset\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelf->__PVT__pc = VL_RAND_RESET_I(32);
    vlSelf->__PVT__instruction = VL_RAND_RESET_I(32);
    vlSelf->__PVT__predict_pc = VL_RAND_RESET_I(32);
    vlSelf->__PVT__illegal_instr_o = VL_RAND_RESET_I(1);
    VL_RAND_RESET_W(192, vlSelf->__PVT__decoded_instr);
    ...
    vlSelf->__PVT__rv32_fence_i = VL_RAND_RESET_I(1);

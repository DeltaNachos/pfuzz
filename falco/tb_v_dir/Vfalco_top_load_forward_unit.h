...
#ifndef VERILATED_VFALCO_TOP_LOAD_FORWARD_UNIT_H_
#define VERILATED_VFALCO_TOP_LOAD_FORWARD_UNIT_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vfalco_top_load_forward_unit final : public VerilatedModule {
  public:
    // CELLS
    ...
    // CONSTRUCTORS
    Vfalco_top_load_forward_unit(Vfalco_top__Syms* symsp, const char* v__name);
    ~Vfalco_top_load_forward_unit();
    VL_UNCOPYABLE(Vfalco_top_load_forward_unit);

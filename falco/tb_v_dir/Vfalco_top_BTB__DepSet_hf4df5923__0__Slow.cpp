...
VL_ATTR_COLD void Vfalco_top_BTB___stl_sequent__TOP__falco_top__core__instruction_fetch__Branch_target_buffer__0(Vfalco_top_BTB* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vfalco_top_BTB___stl_sequent__TOP__falco_top__core__instruction_fetch__Branch_target_buffer__0\n"); );
...
VL_ATTR_COLD void Vfalco_top_BTB___stl_sequent__TOP__falco_top__core__instruction_fetch__Branch_target_buffer__1(Vfalco_top_BTB* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vfalco_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vfalco_top_BTB___stl_sequent__TOP__falco_top__core__instruction_fetch__Branch_target_buffer__1\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body

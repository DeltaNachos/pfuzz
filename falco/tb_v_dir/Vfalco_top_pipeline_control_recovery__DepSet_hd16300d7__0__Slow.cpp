...
VL_ATTR_COLD void Vfalco_top_pipeline_control_recovery___stl_sequent__TOP__falco_top__core__pipeline_ctrl__0(Vfalco_top_pipeline_control_recovery* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vfalco_top_pipeline_control_recovery___stl_sequent__TOP__falco_top__core__pipeline_ctrl__0\n"); );
...
VL_ATTR_COLD void Vfalco_top_pipeline_control_recovery___stl_sequent__TOP__falco_top__core__pipeline_ctrl__1(Vfalco_top_pipeline_control_recovery* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vfalco_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vfalco_top_pipeline_control_recovery___stl_sequent__TOP__falco_top__core__pipeline_ctrl__1\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vfalco_top_pipeline_control_recovery___stl_comb__TOP__falco_top__core__pipeline_ctrl__0(Vfalco_top_pipeline_control_recovery* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vfalco_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vfalco_top_pipeline_control_recovery___stl_comb__TOP__falco_top__core__pipeline_ctrl__0\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vfalco_top_pipeline_control_recovery___stl_comb__TOP__falco_top__core__pipeline_ctrl__1(Vfalco_top_pipeline_control_recovery* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vfalco_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vfalco_top_pipeline_control_recovery___stl_comb__TOP__falco_top__core__pipeline_ctrl__1\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vfalco_top_pipeline_control_recovery___stl_comb__TOP__falco_top__core__pipeline_ctrl__2(Vfalco_top_pipeline_control_recovery* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vfalco_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vfalco_top_pipeline_control_recovery___stl_comb__TOP__falco_top__core__pipeline_ctrl__2\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body

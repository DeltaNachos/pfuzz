...
VL_ATTR_COLD void Vfalco_top_LS_wo_store_Picker8_1___eval_initial__TOP__falco_top__core__MEM_IQ__selector__mem_picker(Vfalco_top_LS_wo_store_Picker8_1* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vfalco_top_LS_wo_store_Picker8_1___eval_initial__TOP__falco_top__core__MEM_IQ__selector__mem_picker\n"); );
...
VL_ATTR_COLD void Vfalco_top_LS_wo_store_Picker8_1___ctor_var_reset(Vfalco_top_LS_wo_store_Picker8_1* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vfalco_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vfalco_top_LS_wo_store_Picker8_1___ctor_var_reset\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body

...
VL_ATTR_COLD void Vfalco_top_empty_entry_finder8___stl_comb__TOP__falco_top__core__INT_IQ__empty_entry_finder__empty_entry_finder8_inst__2(Vfalco_top_empty_entry_finder8* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vfalco_top_empty_entry_finder8___stl_comb__TOP__falco_top__core__INT_IQ__empty_entry_finder__empty_entry_finder8_inst__2\n"); );
...
VL_ATTR_COLD void Vfalco_top_empty_entry_finder8___stl_comb__TOP__falco_top__core__INT_IQ__empty_entry_finder__empty_entry_finder8_inst__3(Vfalco_top_empty_entry_finder8* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vfalco_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vfalco_top_empty_entry_finder8___stl_comb__TOP__falco_top__core__INT_IQ__empty_entry_finder__empty_entry_finder8_inst__3\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vfalco_top_empty_entry_finder8___stl_comb__TOP__falco_top__core__MEM_IQ__empty_entry_finder__empty_entry_finder8_inst__2(Vfalco_top_empty_entry_finder8* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vfalco_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vfalco_top_empty_entry_finder8___stl_comb__TOP__falco_top__core__MEM_IQ__empty_entry_finder__empty_entry_finder8_inst__2\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__Vcellout__l2_finder__BRA__0__KET____DOT__l2_finder_4__out_id_0 
        = vlSelf->__PVT__l2_finder__BRA__0__KET____DOT__l2_finder_4->__PVT__out_id_0;
...
VL_ATTR_COLD void Vfalco_top_empty_entry_finder8___stl_comb__TOP__falco_top__core__MEM_IQ__empty_entry_finder__empty_entry_finder8_inst__3(Vfalco_top_empty_entry_finder8* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vfalco_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vfalco_top_empty_entry_finder8___stl_comb__TOP__falco_top__core__MEM_IQ__empty_entry_finder__empty_entry_finder8_inst__3\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__out_id_0 = vlSelf->__PVT__l3_finder_4->__PVT__out_id_0;
    vlSelfRef.__PVT__out_id_1 = vlSelf->__PVT__l3_finder_4->__PVT__out_id_1;

...
VL_INLINE_OPT void Vfalco_top_falco_mem_model____Vdpiimwrap_instruction_generator_TOP__falco_top__memory_modelling_inst(IData/*31:0*/ &instruction_generator__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vfalco_top_falco_mem_model____Vdpiimwrap_instruction_generator_TOP__falco_top__memory_modelling_inst\n"); );
    // Body

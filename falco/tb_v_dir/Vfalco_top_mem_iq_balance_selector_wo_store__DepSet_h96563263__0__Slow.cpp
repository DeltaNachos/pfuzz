...
VL_ATTR_COLD void Vfalco_top_mem_iq_balance_selector_wo_store___stl_sequent__TOP__falco_top__core__MEM_IQ__selector__0(Vfalco_top_mem_iq_balance_selector_wo_store* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vfalco_top_mem_iq_balance_selector_wo_store___stl_sequent__TOP__falco_top__core__MEM_IQ__selector__0\n"); );
...
VL_ATTR_COLD void Vfalco_top_mem_iq_balance_selector_wo_store___stl_sequent__TOP__falco_top__core__MEM_IQ__selector__1(Vfalco_top_mem_iq_balance_selector_wo_store* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vfalco_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vfalco_top_mem_iq_balance_selector_wo_store___stl_sequent__TOP__falco_top__core__MEM_IQ__selector__1\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body

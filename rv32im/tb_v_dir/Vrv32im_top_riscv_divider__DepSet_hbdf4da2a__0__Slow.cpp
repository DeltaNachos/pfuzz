...
VL_ATTR_COLD void Vrv32im_top_riscv_divider___stl_sequent__TOP__rv32im_top__core__u_div__0(Vrv32im_top_riscv_divider* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vrv32im_top_riscv_divider___stl_sequent__TOP__rv32im_top__core__u_div__0\n"); );
    // Body
...
VL_ATTR_COLD void Vrv32im_top_riscv_divider___stl_sequent__TOP__rv32im_top__core__u_div__1(Vrv32im_top_riscv_divider* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vrv32im_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vrv32im_top_riscv_divider___stl_sequent__TOP__rv32im_top__core__u_div__1\n"); );
    // Body
...
VL_ATTR_COLD void Vrv32im_top_riscv_divider___stl_sequent__TOP__rv32im_top__core__u_div__2(Vrv32im_top_riscv_divider* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vrv32im_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vrv32im_top_riscv_divider___stl_sequent__TOP__rv32im_top__core__u_div__2\n"); );
    // Body
    vlSelf->__PVT__div_start_w = ((IData)(vlSelf->__PVT__opcode_valid_i) 
                                  & (IData)(vlSelf->__PVT__div_rem_inst_w));
}

VL_ATTR_COLD void Vrv32im_top_riscv_divider___ctor_var_reset(Vrv32im_top_riscv_divider* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vrv32im_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vrv32im_top_riscv_divider___ctor_var_reset\n"); );
    // Body

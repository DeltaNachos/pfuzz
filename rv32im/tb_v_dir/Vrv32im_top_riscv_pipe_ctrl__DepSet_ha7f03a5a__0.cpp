...
VL_INLINE_OPT void Vrv32im_top_riscv_pipe_ctrl___nba_sequent__TOP__rv32im_top__core__u_issue__u_pipe_ctrl__0(Vrv32im_top_riscv_pipe_ctrl* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vrv32im_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrv32im_top_riscv_pipe_ctrl___nba_sequent__TOP__rv32im_top__core__u_issue__u_pipe_ctrl__0\n"); );
    // Body
...
VL_INLINE_OPT void Vrv32im_top_riscv_pipe_ctrl___nba_sequent__TOP__rv32im_top__core__u_issue__u_pipe_ctrl__1(Vrv32im_top_riscv_pipe_ctrl* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vrv32im_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrv32im_top_riscv_pipe_ctrl___nba_sequent__TOP__rv32im_top__core__u_issue__u_pipe_ctrl__1\n"); );
    // Body
...
VL_INLINE_OPT void Vrv32im_top_riscv_pipe_ctrl___nba_comb__TOP__rv32im_top__core__u_issue__u_pipe_ctrl__1(Vrv32im_top_riscv_pipe_ctrl* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vrv32im_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrv32im_top_riscv_pipe_ctrl___nba_comb__TOP__rv32im_top__core__u_issue__u_pipe_ctrl__1\n"); );
    // Body
...
VL_INLINE_OPT void Vrv32im_top_riscv_pipe_ctrl___nba_comb__TOP__rv32im_top__core__u_issue__u_pipe_ctrl__4(Vrv32im_top_riscv_pipe_ctrl* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vrv32im_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrv32im_top_riscv_pipe_ctrl___nba_comb__TOP__rv32im_top__core__u_issue__u_pipe_ctrl__4\n"); );
    // Body

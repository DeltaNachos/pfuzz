...
VL_ATTR_COLD void Vrv32im_top_rv32im_top___ctor_var_reset(Vrv32im_top_rv32im_top* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vrv32im_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+      Vrv32im_top_rv32im_top___ctor_var_reset\n"); );
    // Body
    ...
    vlSelf->__PVT__icache_inst_w = VL_RAND_RESET_I(32);
    vlSelf->__PVT__intr_i = VL_RAND_RESET_I(1);
    vlSelf->__PVT__reset_vector_i = VL_RAND_RESET_I(32);
    vlSelf->__PVT__cpu_id_i = VL_RAND_RESET_I(1);

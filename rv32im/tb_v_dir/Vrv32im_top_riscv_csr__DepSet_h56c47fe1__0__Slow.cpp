...
VL_ATTR_COLD void Vrv32im_top_riscv_csr___stl_sequent__TOP__rv32im_top__core__u_csr__0(Vrv32im_top_riscv_csr* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vrv32im_top_riscv_csr___stl_sequent__TOP__rv32im_top__core__u_csr__0\n"); );
    // Body
    ...
    vlSymsp->TOP__rv32im_top__core__u_csr__u_csrfile.__PVT__misa_i 
        = vlSelf->__PVT__misa_w;
    vlSymsp->TOP__rv32im_top__core__u_csr__u_csrfile.__PVT__timer_intr_i 
    ...
    vlSymsp->TOP__rv32im_top__core__u_csr__u_csrfile.__PVT__cpu_id_i 
...
VL_ATTR_COLD void Vrv32im_top_riscv_csr___stl_sequent__TOP__rv32im_top__core__u_csr__1(Vrv32im_top_riscv_csr* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vrv32im_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vrv32im_top_riscv_csr___stl_sequent__TOP__rv32im_top__core__u_csr__1\n"); );
    // Body
...
VL_ATTR_COLD void Vrv32im_top_riscv_csr___stl_sequent__TOP__rv32im_top__core__u_csr__2(Vrv32im_top_riscv_csr* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vrv32im_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vrv32im_top_riscv_csr___stl_sequent__TOP__rv32im_top__core__u_csr__2\n"); );
    // Body
...
VL_ATTR_COLD void Vrv32im_top_riscv_csr___stl_sequent__TOP__rv32im_top__core__u_csr__3(Vrv32im_top_riscv_csr* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vrv32im_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vrv32im_top_riscv_csr___stl_sequent__TOP__rv32im_top__core__u_csr__3\n"); );
    // Body
...
VL_ATTR_COLD void Vrv32im_top_riscv_csr___stl_sequent__TOP__rv32im_top__core__u_csr__4(Vrv32im_top_riscv_csr* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vrv32im_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vrv32im_top_riscv_csr___stl_sequent__TOP__rv32im_top__core__u_csr__4\n"); );
    // Body

...
VL_ATTR_COLD void Vrv32im_top_riscv_exec___stl_sequent__TOP__rv32im_top__core__u_exec__2(Vrv32im_top_riscv_exec* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vrv32im_top_riscv_exec___stl_sequent__TOP__rv32im_top__core__u_exec__2\n"); );
    // Body
    ...
    vlSymsp->TOP__rv32im_top__core__u_exec__u_alu.__PVT__alu_op_i 
        = vlSelf->__PVT__alu_func_r;
    vlSymsp->TOP__rv32im_top__core__u_exec__u_alu.__PVT__alu_a_i 
        = vlSelf->__PVT__alu_input_a_r;
    vlSymsp->TOP__rv32im_top__core__u_exec__u_alu.__PVT__alu_b_i 
...
VL_ATTR_COLD void Vrv32im_top_riscv_exec___stl_sequent__TOP__rv32im_top__core__u_exec__3(Vrv32im_top_riscv_exec* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vrv32im_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vrv32im_top_riscv_exec___stl_sequent__TOP__rv32im_top__core__u_exec__3\n"); );
    // Body
    vlSelf->__PVT__alu_p_w = vlSymsp->TOP__rv32im_top__core__u_exec__u_alu.__PVT__alu_p_o;
}

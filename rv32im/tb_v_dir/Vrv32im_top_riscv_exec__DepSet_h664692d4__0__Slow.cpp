...
VL_ATTR_COLD void Vrv32im_top_riscv_exec___eval_initial__TOP__rv32im_top__core__u_exec(Vrv32im_top_riscv_exec* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vrv32im_top_riscv_exec___eval_initial__TOP__rv32im_top__core__u_exec\n"); );
    // Body
...
VL_ATTR_COLD void Vrv32im_top_riscv_exec___stl_sequent__TOP__rv32im_top__core__u_exec__0(Vrv32im_top_riscv_exec* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vrv32im_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vrv32im_top_riscv_exec___stl_sequent__TOP__rv32im_top__core__u_exec__0\n"); );
    // Body
...
VL_ATTR_COLD void Vrv32im_top_riscv_exec___stl_sequent__TOP__rv32im_top__core__u_exec__1(Vrv32im_top_riscv_exec* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vrv32im_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vrv32im_top_riscv_exec___stl_sequent__TOP__rv32im_top__core__u_exec__1\n"); );
    // Body
...
VL_ATTR_COLD void Vrv32im_top_riscv_exec___ctor_var_reset(Vrv32im_top_riscv_exec* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vrv32im_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vrv32im_top_riscv_exec___ctor_var_reset\n"); );
    // Body

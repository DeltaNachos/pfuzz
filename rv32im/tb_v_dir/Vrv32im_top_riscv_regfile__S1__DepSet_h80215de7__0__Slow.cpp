...
VL_ATTR_COLD void Vrv32im_top_riscv_regfile__S1___stl_sequent__TOP__rv32im_top__core__u_issue__u_regfile__0(Vrv32im_top_riscv_regfile__S1* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrv32im_top_riscv_regfile__S1___stl_sequent__TOP__rv32im_top__core__u_issue__u_regfile__0\n"); );
    // Body
...
VL_ATTR_COLD void Vrv32im_top_riscv_regfile__S1___stl_sequent__TOP__rv32im_top__core__u_issue__u_regfile__1(Vrv32im_top_riscv_regfile__S1* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vrv32im_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrv32im_top_riscv_regfile__S1___stl_sequent__TOP__rv32im_top__core__u_issue__u_regfile__1\n"); );
    // Body
...
VL_ATTR_COLD void Vrv32im_top_riscv_regfile__S1___stl_sequent__TOP__rv32im_top__core__u_issue__u_regfile__2(Vrv32im_top_riscv_regfile__S1* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vrv32im_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrv32im_top_riscv_regfile__S1___stl_sequent__TOP__rv32im_top__core__u_issue__u_regfile__2\n"); );
    // Body

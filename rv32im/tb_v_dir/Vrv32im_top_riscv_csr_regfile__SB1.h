...
#ifndef VERILATED_VRV32IM_TOP_RISCV_CSR_REGFILE__SB1_H_
#define VERILATED_VRV32IM_TOP_RISCV_CSR_REGFILE__SB1_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vrv32im_top_riscv_csr_regfile__SB1 final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vrv32im_top_riscv_csr_regfile__SB1(Vrv32im_top__Syms* symsp, const char* v__name);
    ~Vrv32im_top_riscv_csr_regfile__SB1();
    VL_UNCOPYABLE(Vrv32im_top_riscv_csr_regfile__SB1);

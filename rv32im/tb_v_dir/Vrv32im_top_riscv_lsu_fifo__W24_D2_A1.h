...
#ifndef VERILATED_VRV32IM_TOP_RISCV_LSU_FIFO__W24_D2_A1_H_
#define VERILATED_VRV32IM_TOP_RISCV_LSU_FIFO__W24_D2_A1_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vrv32im_top_riscv_lsu_fifo__W24_D2_A1 final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vrv32im_top_riscv_lsu_fifo__W24_D2_A1(Vrv32im_top__Syms* symsp, const char* v__name);
    ~Vrv32im_top_riscv_lsu_fifo__W24_D2_A1();
    VL_UNCOPYABLE(Vrv32im_top_riscv_lsu_fifo__W24_D2_A1);

...
VL_ATTR_COLD void Vrv32im_top_riscv_lsu_fifo__W24_D2_A1___stl_sequent__TOP__rv32im_top__core__u_lsu__u_lsu_request__0(Vrv32im_top_riscv_lsu_fifo__W24_D2_A1* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrv32im_top_riscv_lsu_fifo__W24_D2_A1___stl_sequent__TOP__rv32im_top__core__u_lsu__u_lsu_request__0\n"); );
    // Body
...
VL_ATTR_COLD void Vrv32im_top_riscv_lsu_fifo__W24_D2_A1___ctor_var_reset(Vrv32im_top_riscv_lsu_fifo__W24_D2_A1* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vrv32im_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrv32im_top_riscv_lsu_fifo__W24_D2_A1___ctor_var_reset\n"); );
    // Body

...
VL_ATTR_COLD void Vrv32im_top_riscv_multiplier___stl_sequent__TOP__rv32im_top__core__u_mul__0(Vrv32im_top_riscv_multiplier* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vrv32im_top_riscv_multiplier___stl_sequent__TOP__rv32im_top__core__u_mul__0\n"); );
    // Init
...
VL_ATTR_COLD void Vrv32im_top_riscv_multiplier___stl_sequent__TOP__rv32im_top__core__u_mul__1(Vrv32im_top_riscv_multiplier* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vrv32im_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vrv32im_top_riscv_multiplier___stl_sequent__TOP__rv32im_top__core__u_mul__1\n"); );
    // Body
...
VL_ATTR_COLD void Vrv32im_top_riscv_multiplier___stl_sequent__TOP__rv32im_top__core__u_mul__2(Vrv32im_top_riscv_multiplier* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vrv32im_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vrv32im_top_riscv_multiplier___stl_sequent__TOP__rv32im_top__core__u_mul__2\n"); );
    // Body
...
VL_ATTR_COLD void Vrv32im_top_riscv_multiplier___ctor_var_reset(Vrv32im_top_riscv_multiplier* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vrv32im_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vrv32im_top_riscv_multiplier___ctor_var_reset\n"); );
    // Body

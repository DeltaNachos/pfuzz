...
VL_ATTR_COLD void Vrv32im_top_riscv_mmu__MBffffffff_M0___eval_initial__TOP__rv32im_top__core__u_mmu(Vrv32im_top_riscv_mmu__MBffffffff_M0* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vrv32im_top_riscv_mmu__MBffffffff_M0___eval_initial__TOP__rv32im_top__core__u_mmu\n"); );
    // Body
    vlSelf->__PVT__genblk1__DOT__lsu_out_cacheable_r = 1U;
}
...
VL_ATTR_COLD void Vrv32im_top_riscv_mmu__MBffffffff_M0___stl_sequent__TOP__rv32im_top__core__u_mmu__0(Vrv32im_top_riscv_mmu__MBffffffff_M0* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vrv32im_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vrv32im_top_riscv_mmu__MBffffffff_M0___stl_sequent__TOP__rv32im_top__core__u_mmu__0\n"); );
    // Body
...
VL_ATTR_COLD void Vrv32im_top_riscv_mmu__MBffffffff_M0___stl_sequent__TOP__rv32im_top__core__u_mmu__1(Vrv32im_top_riscv_mmu__MBffffffff_M0* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vrv32im_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vrv32im_top_riscv_mmu__MBffffffff_M0___stl_sequent__TOP__rv32im_top__core__u_mmu__1\n"); );
    // Body
...
VL_ATTR_COLD void Vrv32im_top_riscv_mmu__MBffffffff_M0___stl_sequent__TOP__rv32im_top__core__u_mmu__2(Vrv32im_top_riscv_mmu__MBffffffff_M0* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vrv32im_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vrv32im_top_riscv_mmu__MBffffffff_M0___stl_sequent__TOP__rv32im_top__core__u_mmu__2\n"); );
    // Body
...
VL_ATTR_COLD void Vrv32im_top_riscv_mmu__MBffffffff_M0___stl_sequent__TOP__rv32im_top__core__u_mmu__3(Vrv32im_top_riscv_mmu__MBffffffff_M0* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vrv32im_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vrv32im_top_riscv_mmu__MBffffffff_M0___stl_sequent__TOP__rv32im_top__core__u_mmu__3\n"); );
    // Body
...
VL_ATTR_COLD void Vrv32im_top_riscv_mmu__MBffffffff_M0___ctor_var_reset(Vrv32im_top_riscv_mmu__MBffffffff_M0* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vrv32im_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vrv32im_top_riscv_mmu__MBffffffff_M0___ctor_var_reset\n"); );
    // Body
    ...
    vlSelf->__PVT__fetch_out_inst_i = VL_RAND_RESET_I(32);
    ...
    vlSelf->__PVT__fetch_in_inst_o = VL_RAND_RESET_I(32);

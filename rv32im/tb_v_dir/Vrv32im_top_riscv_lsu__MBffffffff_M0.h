...
#ifndef VERILATED_VRV32IM_TOP_RISCV_LSU__MBFFFFFFFF_M0_H_
#define VERILATED_VRV32IM_TOP_RISCV_LSU__MBFFFFFFFF_M0_H_  // guard

#include "verilated.h"
class Vrv32im_top_riscv_lsu_fifo__W24_D2_A1;


class Vrv32im_top__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vrv32im_top_riscv_lsu__MBffffffff_M0 final : public VerilatedModule {
  public:
    // CELLS
    Vrv32im_top_riscv_lsu_fifo__W24_D2_A1* __PVT__u_lsu_request;
    ...
    // CONSTRUCTORS
    Vrv32im_top_riscv_lsu__MBffffffff_M0(Vrv32im_top__Syms* symsp, const char* v__name);
    ~Vrv32im_top_riscv_lsu__MBffffffff_M0();
    VL_UNCOPYABLE(Vrv32im_top_riscv_lsu__MBffffffff_M0);

...
VL_ATTR_COLD void Vrv32im_top_riscv_csr_regfile__SB1___stl_sequent__TOP__rv32im_top__core__u_csr__u_csrfile__0(Vrv32im_top_riscv_csr_regfile__SB1* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrv32im_top_riscv_csr_regfile__SB1___stl_sequent__TOP__rv32im_top__core__u_csr__u_csrfile__0\n"); );
    // Body
...
VL_ATTR_COLD void Vrv32im_top_riscv_csr_regfile__SB1___stl_sequent__TOP__rv32im_top__core__u_csr__u_csrfile__1(Vrv32im_top_riscv_csr_regfile__SB1* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vrv32im_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrv32im_top_riscv_csr_regfile__SB1___stl_sequent__TOP__rv32im_top__core__u_csr__u_csrfile__1\n"); );
    // Init
...
VL_ATTR_COLD void Vrv32im_top_riscv_csr_regfile__SB1___stl_sequent__TOP__rv32im_top__core__u_csr__u_csrfile__2(Vrv32im_top_riscv_csr_regfile__SB1* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vrv32im_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrv32im_top_riscv_csr_regfile__SB1___stl_sequent__TOP__rv32im_top__core__u_csr__u_csrfile__2\n"); );
    // Body
...
VL_ATTR_COLD void Vrv32im_top_riscv_csr_regfile__SB1___stl_sequent__TOP__rv32im_top__core__u_csr__u_csrfile__3(Vrv32im_top_riscv_csr_regfile__SB1* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vrv32im_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrv32im_top_riscv_csr_regfile__SB1___stl_sequent__TOP__rv32im_top__core__u_csr__u_csrfile__3\n"); );
    // Body
...
VL_ATTR_COLD void Vrv32im_top_riscv_csr_regfile__SB1___ctor_var_reset(Vrv32im_top_riscv_csr_regfile__SB1* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vrv32im_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrv32im_top_riscv_csr_regfile__SB1___ctor_var_reset\n"); );
    // Body
    ...
    vlSelf->__PVT__irq_priv_r = VL_RAND_RESET_I(2);
    ...
    vlSelf->__PVT__buffer_mip_w = VL_RAND_RESET_I(1);
    ...
    vlSelf->__PVT__is_exception_w = VL_RAND_RESET_I(1);
    vlSelf->__PVT__exception_s_w = VL_RAND_RESET_I(1);
    vlSelf->__PVT__branch_r = VL_RAND_RESET_I(1);
    vlSelf->__PVT__branch_target_r = VL_RAND_RESET_I(32);
    vlSelf->__Vdly__irq_priv_q = VL_RAND_RESET_I(2);
    vlSelf->__Vdly__csr_mip_upd_q = VL_RAND_RESET_I(1);
    vlSelf->__Vdly__csr_mepc_q = VL_RAND_RESET_I(32);
    vlSelf->__Vdly__csr_sr_q = VL_RAND_RESET_I(32);
    vlSelf->__Vdly__csr_mcause_q = VL_RAND_RESET_I(32);
    vlSelf->__Vdly__csr_mtval_q = VL_RAND_RESET_I(32);
    vlSelf->__Vdly__csr_mtvec_q = VL_RAND_RESET_I(32);
    vlSelf->__Vdly__csr_mip_q = VL_RAND_RESET_I(32);
    vlSelf->__Vdly__csr_mie_q = VL_RAND_RESET_I(32);
    vlSelf->__Vdly__csr_mpriv_q = VL_RAND_RESET_I(2);
    vlSelf->__Vdly__csr_mcycle_q = VL_RAND_RESET_I(32);
    vlSelf->__Vdly__csr_mcycle_h_q = VL_RAND_RESET_I(32);
    vlSelf->__Vdly__csr_mscratch_q = VL_RAND_RESET_I(32);
    vlSelf->__Vdly__csr_mtimecmp_q = VL_RAND_RESET_I(32);
    vlSelf->__Vdly__csr_mtime_ie_q = VL_RAND_RESET_I(1);
    vlSelf->__Vdly__csr_medeleg_q = VL_RAND_RESET_I(32);
    vlSelf->__Vdly__csr_mideleg_q = VL_RAND_RESET_I(32);
    vlSelf->__Vdly__csr_sepc_q = VL_RAND_RESET_I(32);
    vlSelf->__Vdly__csr_stvec_q = VL_RAND_RESET_I(32);
    vlSelf->__Vdly__csr_scause_q = VL_RAND_RESET_I(32);
    vlSelf->__Vdly__csr_stval_q = VL_RAND_RESET_I(32);
    vlSelf->__Vdly__csr_satp_q = VL_RAND_RESET_I(32);
    vlSelf->__Vdly__csr_sscratch_q = VL_RAND_RESET_I(32);
    vlSelf->__Vdly__csr_mip_next_q = VL_RAND_RESET_I(32);
}

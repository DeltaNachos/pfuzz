...
VL_ATTR_COLD void Vssrv_top_scr1_pipe_idu___stl_sequent__TOP__ssrv_top__core__i_pipe_top__i_pipe_idu__0(Vssrv_top_scr1_pipe_idu* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vssrv_top_scr1_pipe_idu___stl_sequent__TOP__ssrv_top__core__i_pipe_top__i_pipe_idu__0\n"); );
    // Body
...
VL_ATTR_COLD void Vssrv_top_scr1_pipe_idu___stl_comb__TOP__ssrv_top__core__i_pipe_top__i_pipe_idu__0(Vssrv_top_scr1_pipe_idu* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vssrv_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vssrv_top_scr1_pipe_idu___stl_comb__TOP__ssrv_top__core__i_pipe_top__i_pipe_idu__0\n"); );
    // Body
    vlSelf->__PVT__idu2ifu_rdy = vlSelf->__PVT__exu2idu_rdy;
}

VL_ATTR_COLD void Vssrv_top_scr1_pipe_idu___ctor_var_reset(Vssrv_top_scr1_pipe_idu* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vssrv_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vssrv_top_scr1_pipe_idu___ctor_var_reset\n"); );
    // Body
    ...
    vlSelf->__PVT__instr_type = VL_RAND_RESET_I(2);
    vlSelf->__PVT__rvi_opcode = VL_RAND_RESET_I(5);
    vlSelf->__PVT__rvi_illegal = VL_RAND_RESET_I(1);
    vlSelf->__PVT__funct3 = VL_RAND_RESET_I(3);
    vlSelf->__PVT__funct7 = VL_RAND_RESET_I(7);
    vlSelf->__PVT__funct12 = VL_RAND_RESET_I(12);
    vlSelf->__PVT__shamt = VL_RAND_RESET_I(5);
    vlSelf->__PVT__rvc_illegal = VL_RAND_RESET_I(1);
}

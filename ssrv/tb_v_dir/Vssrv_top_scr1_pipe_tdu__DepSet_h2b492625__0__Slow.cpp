...
VL_ATTR_COLD void Vssrv_top_scr1_pipe_tdu___stl_sequent__TOP__ssrv_top__core__i_pipe_top__i_pipe_tdu__0(Vssrv_top_scr1_pipe_tdu* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vssrv_top_scr1_pipe_tdu___stl_sequent__TOP__ssrv_top__core__i_pipe_top__i_pipe_tdu__0\n"); );
    // Body
...
VL_ATTR_COLD void Vssrv_top_scr1_pipe_tdu___stl_comb__TOP__ssrv_top__core__i_pipe_top__i_pipe_tdu__0(Vssrv_top_scr1_pipe_tdu* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vssrv_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vssrv_top_scr1_pipe_tdu___stl_comb__TOP__ssrv_top__core__i_pipe_top__i_pipe_tdu__0\n"); );
    // Body
...
VL_ATTR_COLD void Vssrv_top_scr1_pipe_tdu___stl_comb__TOP__ssrv_top__core__i_pipe_top__i_pipe_tdu__1(Vssrv_top_scr1_pipe_tdu* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vssrv_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vssrv_top_scr1_pipe_tdu___stl_comb__TOP__ssrv_top__core__i_pipe_top__i_pipe_tdu__1\n"); );
    // Init
...
VL_ATTR_COLD void Vssrv_top_scr1_pipe_tdu___stl_comb__TOP__ssrv_top__core__i_pipe_top__i_pipe_tdu__2(Vssrv_top_scr1_pipe_tdu* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vssrv_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vssrv_top_scr1_pipe_tdu___stl_comb__TOP__ssrv_top__core__i_pipe_top__i_pipe_tdu__2\n"); );
    // Body
...
VL_ATTR_COLD void Vssrv_top_scr1_pipe_tdu___stl_comb__TOP__ssrv_top__core__i_pipe_top__i_pipe_tdu__3(Vssrv_top_scr1_pipe_tdu* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vssrv_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vssrv_top_scr1_pipe_tdu___stl_comb__TOP__ssrv_top__core__i_pipe_top__i_pipe_tdu__3\n"); );
    // Init
    CData/*31:0*/ __Vtemp_1;
    CData/*31:0*/ __Vtemp_2;
...
VL_ATTR_COLD void Vssrv_top_scr1_pipe_tdu___ctor_var_reset(Vssrv_top_scr1_pipe_tdu* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vssrv_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vssrv_top_scr1_pipe_tdu___ctor_var_reset\n"); );
    // Body
    vlSelf->__PVT__rst_n = VL_RAND_RESET_I(1);
    vlSelf->__PVT__clk = VL_RAND_RESET_I(1);
    vlSelf->__PVT__clk_en = VL_RAND_RESET_I(1);
    vlSelf->__PVT__dsbl = VL_RAND_RESET_I(1);
    ...
    vlSelf->__PVT__csr2tdu_rdata = VL_RAND_RESET_I(32);
    vlSelf->__PVT__csr2tdu_resp = VL_RAND_RESET_I(1);
    ...
    vlSelf->__PVT__tdu2lsu_d_mon = VL_RAND_RESET_Q(35);
    ...
    vlSelf->__PVT__tdu2hdu_dmode_req = VL_RAND_RESET_I(1);
    vlSelf->__PVT__tselect_ff = VL_RAND_RESET_I(2);
    vlSelf->__PVT__tdata2 = VL_RAND_RESET_Q(64);
    vlSelf->__PVT__csr_addr_tselect_cmb = VL_RAND_RESET_I(1);
    vlSelf->__PVT__csr_addr_mcontrol_cmb = VL_RAND_RESET_I(2);
    vlSelf->__PVT__csr_addr_tdata2_cmb = VL_RAND_RESET_I(2);
    vlSelf->__PVT__csr_wr_cmb = VL_RAND_RESET_I(1);
    vlSelf->__PVT__csr_wr_data_cmb = VL_RAND_RESET_I(32);
    vlSelf->__PVT__clk_en_mcontrol_cmb = VL_RAND_RESET_I(2);
    vlSelf->__PVT__mcontrol_dmode_ff = VL_RAND_RESET_I(2);
    vlSelf->__PVT__mcontrol_execution_hit_cmb = VL_RAND_RESET_I(2);
    vlSelf->__PVT__mcontrol_ldst_hit_cmb = VL_RAND_RESET_I(2);
    vlSelf->__PVT__mcontrol_action_ff = VL_RAND_RESET_I(2);
    vlSelf->__PVT__mcontrol_match_ff = VL_RAND_RESET_I(4);
    vlSelf->__PVT__mcontrol_hit_ff = VL_RAND_RESET_I(2);
    vlSelf->__PVT__mcontrol_m_ff = VL_RAND_RESET_I(2);
    vlSelf->__PVT__mcontrol_execution_ff = VL_RAND_RESET_I(2);
    vlSelf->__PVT__mcontrol_load_ff = VL_RAND_RESET_I(2);
    vlSelf->__PVT__mcontrol_store_ff = VL_RAND_RESET_I(2);
    vlSelf->__PVT__mcontrol_write_en = VL_RAND_RESET_I(2);
    vlSelf->__PVT__csr_addr_icount_cmb = VL_RAND_RESET_I(1);
    vlSelf->__PVT__clk_en_icount_cmb = VL_RAND_RESET_I(1);
    vlSelf->__PVT__icount_decrement_cmb = VL_RAND_RESET_I(1);
    vlSelf->__PVT__icount_hit_cmb = VL_RAND_RESET_I(1);
    vlSelf->__PVT__icount_skip_ff = VL_RAND_RESET_I(1);
    vlSelf->__PVT__icount_dmode_ff = VL_RAND_RESET_I(1);
    vlSelf->__PVT__icount_action_ff = VL_RAND_RESET_I(1);
    vlSelf->__PVT__icount_hit_ff = VL_RAND_RESET_I(1);
    vlSelf->__PVT__icount_m_ff = VL_RAND_RESET_I(1);
    vlSelf->__PVT__icount_count_ff = VL_RAND_RESET_I(14);
    vlSelf->__PVT__icount_write_en = VL_RAND_RESET_I(1);
    ...
    vlSelf->__Vdly__tselect_ff = VL_RAND_RESET_I(2);
    vlSelf->__Vdly__icount_dmode_ff = VL_RAND_RESET_I(1);
    vlSelf->__Vdly__icount_m_ff = VL_RAND_RESET_I(1);
    vlSelf->__Vdly__icount_action_ff = VL_RAND_RESET_I(1);
    vlSelf->__Vdly__icount_hit_ff = VL_RAND_RESET_I(1);
    vlSelf->__Vdly__icount_count_ff = VL_RAND_RESET_I(14);
    vlSelf->__Vdly__icount_skip_ff = VL_RAND_RESET_I(1);
    vlSelf->__Vdly__mcontrol_dmode_ff = VL_RAND_RESET_I(2);
    vlSelf->__Vdly__mcontrol_m_ff = VL_RAND_RESET_I(2);
    vlSelf->__Vdly__mcontrol_execution_ff = VL_RAND_RESET_I(2);
    vlSelf->__Vdly__mcontrol_load_ff = VL_RAND_RESET_I(2);
    vlSelf->__Vdly__mcontrol_store_ff = VL_RAND_RESET_I(2);
    vlSelf->__Vdly__mcontrol_action_ff = VL_RAND_RESET_I(2);
    vlSelf->__Vdly__mcontrol_hit_ff = VL_RAND_RESET_I(2);
    vlSelf->__Vdly__tdata2 = VL_RAND_RESET_Q(64);
}
